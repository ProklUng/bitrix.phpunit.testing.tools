...
use Arrilot\BitrixMigrationsFork\Constructors\FieldConstructor;
use Arrilot\BitrixMigrationsFork\Interfaces\DatabaseStorageInterface;
use Arrilot\BitrixMigrationsFork\Interfaces\FileStorageInterface;
...
use Arrilot\BitrixMigrationsFork\Storages\FileStorage;
...
class Migrator
{
    ...
    protected function getMigrationObjectByFileName($file)
    {
        ...
        if (!$object instanceof MigrationInterface) {
            throw new Exception("Migration class {$class} must implement Arrilot\\BitrixMigrationsFork\\Interfaces\\MigrationInterface");
        }
